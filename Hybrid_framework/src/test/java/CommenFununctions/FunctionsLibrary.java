...
public class FunctionsLibrary {
	...
	public static void StockTable(String LocatorType,String LocatorValue)throws Throwable{
		...
		Thread.sleep(3000);
		String act_Data=driver.findElement(By.xpath("//table[@class='table ewTable']/tbody/tr[1]/td[7]/div/span/span")).getTagName();
	...
	public static void captsuppnum(String LocatorType, String LocatorValue) throws Throwable
	{
	...
	public static void supplierTable()throws Throwable
	{
		...
		driver.findElement(By.xpath(conpro.getProperty("search-button"))).click();
		Thread.sleep(3000);
		String act_Data=driver.findElement(By.xpath("//table[@class='table ewTable']/tbody/tr[1]/td[6]/div/span/span")).getTagName();
		Reporter.log(act_Data+"  "+Exp_Data,true);
		try {
			Assert.assertEquals(act_Data, Exp_Data,"stock number not match");
		}
